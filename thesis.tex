...
%     filename  = "thesis.tex",
%     date      = "01/01/2014",
%     authors   = "Kazimierz Sliwa",
%     copyright = "Kazimierz Sliwa",
...
%%%%%%%%%%%%%%%%
% Title
\title{Luminous Infrared Galaxies with the Submillimeter Array}
...
\thesislistofacronyms{SupplementaryMaterial/ListofAcronyms}
